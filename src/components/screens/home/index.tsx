        ...
        <div className="mx-auto flex w-full max-w-2xl flex-col items-center justify-center">
          <div className="w-full flex-col px-0 md:px-0 lg:px-0">
            ...
            <p className="mt-8 text-[16px] md:text-[18px]">
              hey there! i am currently exploring rl, low level optimizations,
              and gpu based llm inference.
            </p>

            <p className="mt-4 text-[16px] md:text-[18px]">
              my interests include inference time systems such as vllm and
              sglang, cuda, kernel level optimizations. more broadly, where
              tools from mathematics and optimizations help explain
              representation learning and generalization in models.
            </p>

            <p className="mt-4 text-[16px] md:text-[18px]">
              interests: low level systems, hpc, cuda, oi, pacific++ & cppcon
              confs
            </p>
